...
const StatCard = ({ icon: Icon, title, value, subtitle, trend, color = "blue", loading = false }) => {
  ...
  return (
    <div className="bg-white/70 backdrop-blur-xl rounded-xl p-6 shadow-sm border border-gray-100/50 hover:shadow-lg transition-all duration-300 group">
      <div className="flex items-center justify-between mb-4">
        ...
        <div key={i} className="bg-white/70 rounded-xl p-6 animate-pulse">
          ...
          <div className="space-y-3">
            {Array.from({ length: 3 }).map((_, j) => (
              <div key={j} className="w-full h-4 bg-gray-200 rounded" />
            ))}
          </div>
        </div>
      ))}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Library Management System Overview</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <select
                ...
                className="px-4 py-2 bg-white/50 border border-gray-200/50 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all duration-300"
              >
            ...
            <div className="space-y-3">
              {analytics.recentIssues.length > 0 ? (
                analytics.recentIssues.map((issue) => (
                  <div key={issue.id} className="flex items-center space-x-3 p-3 bg-gray-50/50 rounded-lg">
            ...
            <div className="space-y-3">
              {analytics.recentReturns.length > 0 ? (
                analytics.recentReturns.map((returnItem) => (
                  <div key={returnItem.id} className="flex items-center space-x-3 p-3 bg-gray-50/50 rounded-lg">
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-xl p-6 shadow-sm border border-gray-100/50">
            ...
            <div className="space-y-3">
              {notifications.slice(0, 3).map((notification) => (
                <div key={notification.id} className="flex items-start space-x-3 p-4 bg-yellow-50/50 border border-yellow-200/50 rounded-lg">
